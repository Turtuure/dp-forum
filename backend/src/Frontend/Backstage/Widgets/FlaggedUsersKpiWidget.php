...
final class FlaggedUsersKpiWidget extends Widget
{
    public function __construct() {}

    public function id(): string             { return 'forum.flagged_users_kpi'; }
    ...
    public function labelKey(): string         { return 'backstage.dashboard.widget.flagged_users_kpi.label'; }
    public function descriptionKey(): string   { return 'backstage.dashboard.widget.flagged_users_kpi.description'; }
    ...
    {
        // TODO(v1+): wire ListForumStats users-with-active-warnings count
