...
final class ReportsKpiWidget extends Widget
{
    public function __construct() {}

    public function id(): string             { return 'forum.reports_kpi'; }
    ...
    public function labelKey(): string         { return 'backstage.dashboard.widget.reports_kpi.label'; }
    public function descriptionKey(): string   { return 'backstage.dashboard.widget.reports_kpi.description'; }
    ...
    {
        // TODO(v1+): wire ListForumStats unresolved reports count
