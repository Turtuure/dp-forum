...
final class PinnedTopicsKpiWidget extends Widget
{
    public function __construct() {}

    public function id(): string             { return 'forum.pinned_topics_kpi'; }
    ...
    public function labelKey(): string         { return 'backstage.dashboard.widget.pinned_topics_kpi.label'; }
    public function descriptionKey(): string   { return 'backstage.dashboard.widget.pinned_topics_kpi.description'; }
    ...
    {
        // TODO(v1+): wire ListForumStats pinned-topics count
